...
namespace CS_ClassLibraryTester
{
    ...
    public class MephButton : Control
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.FillPath(new SolidBrush(Color.FromArgb(45, 45, 45)), Draw.RoundRect(ClientRectangle, 3));
            G.DrawPath(new Pen(new SolidBrush(Color.FromArgb(45, 45, 45))), Draw.RoundRect(ClientRectangle, 3));
            G.DrawPath(new Pen(new SolidBrush(Color.FromArgb(45, 45, 45))), Draw.RoundRect(new Rectangle(1, 1, Width - 3, Height - 3), 3));
